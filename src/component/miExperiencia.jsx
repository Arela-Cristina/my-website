...
export default function MiExperiencia() {
    return (
        <AnimatedSection className="w-full  flex flex-col items-center pb-5 md:flex-row md:h-screen" style={{ backgroundColor: '#851851' }}
        >

            <div className='w-5/6 pt-5 bg-amber-50'>
            ...
            <div className='w-5/6 mt-5 bg-amber-50'>
