...
export default function SobreMi() {
    return (
        <AnimatedSection className="w-full flex flex-col justify-center gap-8 pt-5 pb-5 sm:h-screen xl:items-center bg-orange-200">

            {/* seccion 1 */}
            <div className="max-w-6xl flex flex-col mx-8 md:flex-row bg-sky-100">
            ...
            {/* seccion 2 */}
            <div className="max-w-6xl flex flex-col mx-8 md:flex-row  bg-sky-950">
                <div className="flex justify-center  py-8  md:items-center md:w-2/5 bg-violet-300">
                    <FontAwesomeIcon icon={faUserAstronaut} size="2x" />
                </div>
                <div className="md:w-3/5">
